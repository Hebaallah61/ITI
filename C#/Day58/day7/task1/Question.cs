...
namespace task1
{
    internal class Question
    {
        ...
        //------------------------
        public string choanwers { get; }//modelanswer AnswersList
        //------------------------

        public Question(int _id, int _marks, string _header, string _body,Type _type,string _ans)
        {
            id= _id;
            marks = _marks;
            header = _header;
