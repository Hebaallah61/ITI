...
namespace task1
{
    internal class Final_exam:Exam
    {
        ...
        public Final_exam() { }
        public Final_exam(string time, int num_of_q) : base(time, num_of_q) { }

        public Final_exam(string time, int number_of_Questions, Question[] _questions, choose_all[] _ch_all, choose_one[] _chone, T_F[] _t_f) : base(time, number_of_Questions,_questions,_ch_all,_chone,_t_f) { }
        ...
        public override void ShowExam(Question[] qs, choose_one[] chone, choose_all[] chone_all, T_F[] t_F)
        {
            ...
            Console.WriteLine("=====================FINAL EXAM========================" + "Time:" + Time);
